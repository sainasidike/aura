...
import { NatalChartSVG, ParamsDisplay, AspectGrid } from '@/components/chart/AstrologyComponents';
import type { AstrologyChart, TimeStandardization } from '@/types';
...
function AstrologyContent() {
  ...
  const [data, setData] = useState<{ timeInfo: TimeStandardization; chart: AstrologyChart } | null>(null);
      ...
      <div className="mx-auto max-w-2xl">
        ...
        {data && !loading && (
          <div className="space-y-6">
            <NatalChartSVG chart={data.chart} />
            <ParamsDisplay chart={data.chart} />
            <AspectGrid chart={data.chart} />
          </div>
        )}
      </div>
    </div>
