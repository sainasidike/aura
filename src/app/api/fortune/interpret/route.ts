...
合格的年运示例：
- 事业✅："上半年木星过你的10宫，是近12年最好的事业窗口——适合跳槽、谈升职、推新项目。但9月后土星四分MC，下半年节奏要放慢，重心从扩张转向巩固已有成果"
- 爱情✅："日返金星落5宫三合本命月亮，今年恋爱运明显比去年好。单身的话，5-7月社交场合最多；有伴的话，年底前可能会讨论同居或婚姻等进一步的承诺"
- 健康✅："日返火星落6宫，今年精力旺但容易过度消耗。上半年适合建立运动习惯，下半年注意肠胃——火星6宫对应消化系统，少吃生冷和辛辣"`;
...
合格的月运示例：
- 事业✅："月返太阳落10宫，本月是事业冲刺期——手头的项目或KPI在月中会迎来关键节点。但月返火星四分土星，推进过程中会遇到流程卡点或领导意见反复，月初就把方案备齐，别等到最后一周"
- 爱情✅："月返金星落3宫六合本命月亮，本月通过聊天、发消息、朋友圈互动升温感情的效果特别好。单身的可以主动找心仪的人搭话；有伴侣的适合安排一次短途周末游"
- 健康✅："月返火星落1宫，精力比上个月旺很多，适合开始一个新的运动计划。但火星1宫也意味着容易头疼或面部过敏，护肤品换季要注意"`;
...
合格的周运示例：
- 事业✅："周一到周三行运水星三合本命太阳，沟通效率高，适合约谈客户、提交方案、做汇报；周四后火星四分本命土星，执行层面容易卡壳，把需要审批的事提前到周中完成"
- 爱情✅："本周前半段金星过你的5宫，约会意愿强，周二或周三最适合约心仪的人出来。周末月亮过8宫，情绪偏内向，不太想社交，适合和伴侣宅家看电影"
- 健康✅："行运火星在你的6宫且合相本命火星，本周运动欲望爆棚——但周四后容易肌肉拉伤，运动前热身要做足，别硬上大重量"`;
...
**合格的解读标准：**
- 📌必须说出"会发生什么事"，而不是"可能有变化"
- 💡建议必须是具体动作（"周三前把方案交了"），不是态度（"保持积极"）
- ⚠️注意事项必须指出具体风险场景（"和同事讨论预算时容易起冲突"），不是泛泛警告（"注意人际关系"）
- 语气像一个看过你星盘的好朋友在提醒你，直接、精准、有画面感`;
